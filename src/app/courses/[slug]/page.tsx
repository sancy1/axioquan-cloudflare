        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-3 gap-12 items-end">
            <div className="md:col-span-2">
              ...
              {course.subtitle && <p className="text-xl opacity-90 mb-6 text-gray-200">{course.subtitle}</p>}
              ...
              <div className="flex gap-3 mb-6">
                <LikeButton
                  courseId={course.id}
                  initialLikeCount={course.like_count || 0}
                  size="lg" showCount={true} variant="outline"
                  className="bg-white/10 border-white/20 text-white hover:bg-white/20"
                />
                <ShareButton
                  courseId={course.id}
            ...
            <div className="bg-gray-800 text-white rounded-2xl p-8 shadow-2xl h-fit border border-gray-700">
              <div className="w-full h-48 rounded-lg overflow-hidden mb-6 bg-gray-700 relative">
                {course.thumbnail_url ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center">
                    <span className="text-6xl">{course.content_type === 'video' ? '🎬' : '📚'}</span>
                  </div>
                )}
              </div>
              ...
              <CourseEnrollment courseId={course.id} courseSlug={course.slug} priceCents={course.price_cents} />
