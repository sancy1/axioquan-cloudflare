...
// // /src/app/(auth)/login/page.tsx
// // # User login page — redesigned with split layout
...
//               </svg>
//             </div>
//             <span className="text-white font-bold text-xl tracking-tight">axioquan</span>
//           </div>
//         </div>

//         {/* Bottom marketing copy + signup CTA */}
//         <div className="relative z-10 mt-auto p-10 pb-12">
//           <div className="max-w-sm">
//             <div className="inline-flex items-center gap-2 bg-violet-600/20 border border-violet-500/30 rounded-full px-3 py-1 mb-5">
...
//               <Link
//                 href="/signup"
//                 className="inline-flex items-center gap-2 bg-white text-gray-900 font-semibold text-sm px-5 py-2.5 rounded-full hover:bg-gray-100 transition-colors shadow-lg"
//               >
//                 Create free account
...
//       <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 py-12 bg-[#0d0d0d] relative">
...
//             </svg>
//           </div>
//           <span className="text-white font-bold text-lg">axioquan</span>
//         </div>

//         <div className="w-full max-w-sm">

//           {/* Sign in / Create account toggle */}
//           <div className="flex bg-[#1a1a1a] rounded-full p-1 mb-8 border border-white/5">
//             <button className="flex-1 py-2 rounded-full bg-violet-600 text-white text-sm font-semibold transition-all shadow-lg shadow-violet-900/40">
//               Sign in
//             </button>
//             <Link
//               href="/signup"
...
//           {/* Darker overlay — heavier layers for legibility */}
//           <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/60 to-black/40" />
//           <div className="absolute inset-0 bg-gradient-to-r from-black/20 to-black/40" />
//           {/* Extra flat darkening layer */}
//           <div className="absolute inset-0 bg-black/30" />

//           {/* Logo — desktop only (header handles mobile branding) */}
//           {/* <div className="relative z-10 p-6 sm:p-8 hidden lg:block">
//             <div className="flex items-center gap-3">
//               <div className="w-9 h-9 rounded-xl bg-violet-600 flex items-center justify-center shadow-lg shadow-violet-900/50">
//                 <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
//                   <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" fill="white"/>
...
//               {/* Stats row */}
//               <div className="flex items-center gap-4 sm:gap-6 mb-5 lg:mb-8">
//                 <div>
//                   <p className="text-white font-bold text-base lg:text-lg">12k+</p>
//                   <p className="text-gray-400 text-xs">Active learners</p>
//                 </div>
//                 <div className="w-px h-7 bg-white/10" />
//                 <div>
//                   <p className="text-white font-bold text-base lg:text-lg">98%</p>
//                   <p className="text-gray-400 text-xs">Satisfaction rate</p>
//                 </div>
//                 <div className="w-px h-7 bg-white/10" />
//                 <div>
//                   <p className="text-white font-bold text-base lg:text-lg">500+</p>
...
//                 <Link
//                   href="/signup"
//                   className="inline-flex items-center gap-2 bg-white text-gray-900 font-semibold text-xs sm:text-sm px-4 sm:px-5 py-2 sm:py-2.5 rounded-full hover:bg-gray-100 transition-colors shadow-lg"
//                 >
//                   Create free account
...
//               <button className="cursor-pointer flex-1 py-2 rounded-full bg-violet-600 text-white text-sm font-semibold shadow-lg shadow-violet-900/40 cursor-default">
//                 Sign in
//               </button>
//               <Link
//                 href="/signup"
...
//             {/* Working login form — all logic/validation untouched */}
//             <LoginForm />
...
//               {/* Subtext — hidden on mobile */}
//               <p className="hidden sm:block text-gray-300 text-sm leading-relaxed mb-5 lg:mb-8">
//                 Join thousands of students already collaborating, sharing knowledge, and
//                 accelerating their learning journey on Axioquan.
//               </p>

//               {/* ── Dynamic stats — fetched client-side via LoginStats ── */}
//               <LoginStats />
