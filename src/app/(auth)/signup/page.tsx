    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col">
      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="relative w-full lg:w-1/2 h-72 sm:h-80 md:h-96 lg:h-auto overflow-hidden flex flex-col">
          ...
          {/* <div className="relative z-10 pt-16 sm:pt-20 lg:pt-24 p-6 sm:p-8 lg:p-10 lg:pb-12"> */}
          {/* <div className="relative z-10 pt-10 sm:pt-12 lg:pt-35 p-6 sm:p-8 lg:p-10 lg:pb-12"> */}
          <div className="relative z-10 pt-10 sm:pt-12 lg:pt-95 p-6 sm:p-8 lg:p-10 lg:pb-12">
